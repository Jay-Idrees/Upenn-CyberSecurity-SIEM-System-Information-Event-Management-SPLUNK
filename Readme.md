...
- `source="windows_server_logs.csv" host="Windows_Server_Logs" sourcetype="csv" <div class=text-blue mb-2> | timechart span=1h count by signature <div/>` Here the command `timechart` will break the data (`signature` variable in this case) into segments